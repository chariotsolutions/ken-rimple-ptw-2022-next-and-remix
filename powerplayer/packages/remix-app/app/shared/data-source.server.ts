...
// TODO also yuck, clean up this awful parsing fun
const configInfo = {
  host: process.env.POSTGRES_HOST,
  user: process.env.POSTGRES_USER,
  port: Number.parseInt(process.env.POSTGRES_PORT || '', 10) || 5432,
  password: process.env.POSTGRES_PASSWORD || '',
  max: Number.parseInt(process.env.MAX_DB_CONNECTIONS || '', 10) || 30,
  idleTimeoutMillis: 30000,// Number.parseInt(process.env.IDLE_DB_TIMEOUT_MS || '', 10) || 0
  connectionTimeoutMillis: 30000 //Number.parseInt(process.env.CONNECTION_DB_TIMEOUT_MS || '', 10) || 0
};

export const pool = new Pool(configInfo);
